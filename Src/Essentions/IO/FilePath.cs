...
namespace Essentions.IO
{
    ...
    public sealed class FilePath : Path
    {
        ...
        public FilePath MakeAbsolute(IFileSystemEnvironment environment)
        {
            if (environment == null) {
        ...
        /// <exception cref="InvalidOperationException">Cannot make a file path absolute with a relative

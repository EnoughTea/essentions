...
namespace Essentions.IO
{
    ...
    public sealed class DirectoryPath : Path
    {
        ...
        /// <exception cref="InvalidOperationException">Cannot combine a directory path with an
        ///  absolute file path.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="path"/> is <see langword="null"/></exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="path"/> is <see langword="null"/></exception>
        /// <exception cref="InvalidOperationException">Cannot combine a directory path with an
        ///  absolute directory path.</exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="path"/> is <see langword="null"/></exception>
        /// <exception cref="InvalidOperationException">The provided path cannot be relative.</exception>

...
namespace Essentions.IO.Globbing
{
    internal sealed class GlobVisitor
    {
        ...
        private readonly IFileSystemEnvironment _environment;

        public GlobVisitor(IFileSystemEnvironment environment)
        {
            _fileSystem = environment.FS;
        ...
        public void VisitRecursiveWildcardSegment(RecursiveWildcardSegment node, GlobVisitorContext context)
        {
            ...
            if (context.FileSystem.Exists(path.Path))
            {
